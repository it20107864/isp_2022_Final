...
function sendMail3() {
   emailjs.send('service_7q1sn6s', 'template_v7f98gs').then(function (res) {
      // console.log("Success", res.status);
      alert('mail sent successfully');
   });
}
function sendMail2() {
   emailjs.send('service_7q1sn6s', 'template_ogw30ms').then(function (res) {
      // console.log("Success", res.status);
      alert('mail sent successfully');
   });
}
...
function NewTab() {
   window.open('https://courseweb.sliit.lk/', '_blank');
}
